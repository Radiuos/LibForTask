def call(def version, def SolutionName, def task, Soln_Config_Name = Soln_Config_Name ?: '', projname = projname ?: '', project_config = project_config ?: '', Output_Filename = Output_Filename ?: '')
{
