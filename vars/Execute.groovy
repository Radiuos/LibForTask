def call(def version, def SolutionName, def task, def Soln_Config_Name = Soln_Config_Name ?: '', def projname = projname ?: '', def project_config = project_config ?: '', def Output_Filename = Output_Filename ?: '')
{
